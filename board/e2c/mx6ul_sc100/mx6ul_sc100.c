...
/* SC100 - Changed I2C1 pin allocation */
...
static iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	/* SC100 - SDHC1 connected to WL1831 so no VSELECT, CD or RTS */
	/* VSELECT */
...
static iomux_v3_cfg_t const usdhc2_cd_pad =
	MX6_PAD_SNVS_TAMPER8__GPIO5_IO08 | MUX_PAD_CTRL(USDHC_DAT3_CD_PAD_CTRL);
...
#define USDHC2_CD_GPIO	IMX_GPIO_NR(5, 8)
...
int board_late_init(void)
{
	...
	env_set("board_name", "sc100");

	if (is_mx6ul_sc100())
		env_set("board_rev", "0a");
	else
		env_set("board_rev", "0b");
#endif
